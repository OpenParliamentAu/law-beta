...
## 1  Subsection 90B(1) (after table item 4)
...
       (8AA)  For the purposes of paragraph (8)(b), a person is **_serving a sentence of imprisonment_** only if:
...
                    <a name="antarct-elector"></a>**_Antarctic elector_** means an elector whose name has been retained on the relevant Roll under Part XVII.
...
                    <a name="declar-place"></a>**_declaration place_** means:
...
<h9 class="ActHead9">Electoral and Referendum Amendment Act (No. 1) 1999</h9>
