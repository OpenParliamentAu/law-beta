![](http://www.comlaw.gov.au/Details/C2006C00159/Html/394757F27732F60ACA2571540021F4A2/$FILE/image001.gif)
...
[8](#8).            No effect on _Crimes (Aviation) Act 1991_                                          12
...
[3](#3).            Application of laws of criminal investigation, procedure and evidence   16
...
[8](#8).            Non-exclusion of consistent extraterritorial legislative schemes        22
...
                    <a name="act"></a>**_act_** includes an omission.
...
                   The Minister must have the intergovernmental agreement, and any amendment to the intergovernmental agreement, published in the _Gazette_.
...
                    <a name="indict-offenc"></a>**_indictable offence_** means an offence for which a charge may be laid by indictment or an equivalent process (whether that is the only, or an optional, way to lay a charge of the offence).

                    <a name="inner-adjac-area"></a>**_inner adjacent area_** for a State means the parts of the adjacent area for the State that are:
...
                    <a name="maritim-offenc"></a>**_maritime offence_** means an offence against a law that applies in the adjacent area for a State under this scheme.

                    <a name="offenc"></a>**_offence_** means an indictable or summary offence.

                    <a name="outer-adjac-area"></a>**_outer adjacent area_** for a State means the part of the adjacent area for the State that is outside the inner adjacent area for the State.

                    <a name="particip-state-minist"></a>**_participating State Minister_** means a Minister responsible for administering a State Act that gives effect to this scheme.
...
                    <a name="summari-offenc"></a>**_summary offence_** means any offence other than an indictable offence.
...
##### <a id="2"></a>2  Application of State criminal law in adjacent area
...
##### <a id="3"></a>3  Application of laws of criminal investigation, procedure and evidence

             (1)  In this clause:

                    <a name="act"></a>**_act_** includes an omission.

                    <a name="area-administr-respons"></a>**_area of administrative responsibility_** for a particular State is:
...
                    <a name="author"></a>**_authority_** includes an agent or official.

                    <a name="commonwealth-judici-proceing"></a>**_Commonwealth judicial proceeding_** means:
...
                    <a name="judici-proceing"></a>**_judicial proceeding_** means:
...
                    <a name="preliminari-examin"></a>**_preliminary examination_** of a charge of an indictable offence means a proceeding to decide whether the defendant should be committed for trial or, if the defendant pleads guilty to the charge, to commit the defendant for sentence or trial.

                    <a name="state-judici-proceing"></a>**_State judicial proceeding_** means:
...
##### <a id="4"></a>4  Evidentiary presumption about the locus of an offence
...
##### <a id="6"></a>6  Effect of the agreement
...
##### <a id="9"></a>9  Exclusion of certain laws from ambit of this scheme
...
##### <a id="15"></a>15  Baselines

                   The **_baseline_** for a State is the part of the baseline of Australia’s territorial sea from which the part of the territorial sea that is within the adjacent area for that State is measured.

##### <a id="16"></a>16  Indicative map
...
![](http://www.comlaw.gov.au/Details/C2006C00159/Html/394757F27732F60ACA2571540021F4A2/$FILE/image002.gif)
...
<div style="BORDER-RIGHT: windowtext 1pt solid; PADDING-RIGHT: 1pt; BORDER-TOP: windowtext 1pt solid; PADDING-LEFT: 1pt; PADDING-BOTTOM: 1pt; MARGIN-LEFT: 2cm; BORDER-LEFT: windowtext 1pt solid; MARGIN-RIGHT: 0cm; PADDING-TOP: 1pt; BORDER-BOTTOM: windowtext 1pt solid">
...
For access to the wording of the amendments made by this Schedule, _see_ Act No. 13, 2000.</div>
...
Remainder: Royal Assent 
  ...
  <tr>
    ...
    <td>
      <div>Schedule 2 (items 14–17): \[ <i>see</i>Note 3]</div>
    </td>
    <td>
      <div>—</div>
    </td>
